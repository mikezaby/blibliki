...
| Feature replies, mode reports, touch events | 30, 69..73, 5..36 | Controller -> Engine | Dropped at the controller input: only channel 16, channel 1 and Shift reach the engine, since the mapper matches on the CC number alone | Sent on channel 7 (`0xB6`) and channel 15 (`0xBE`) |
