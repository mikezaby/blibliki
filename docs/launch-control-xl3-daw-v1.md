...
| Feature replies, mode reports, touch events | 30, 5..36 | Controller -> Engine | Dropped at the controller input when they carry an encoder or fader number off channel 16, since the mapper matches on the CC number alone; buttons pass on any channel | Sent on channel 7 (`0xB6`) and channel 15 (`0xBE`) |
