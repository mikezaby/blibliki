...
class MonoCustomEnvelope
  extends Module<ModuleType.CustomEnvelope>
  implements
    Pick<
    ...
    >
{
  ...
  constructor(
    engineId: string,
    params: ICreateModule<ModuleType.CustomEnvelope>,
  ) {
...
export default class CustomEnvelope extends PolyModule<ModuleType.CustomEnvelope> {
  constructor(
    engineId: string,
    params: IPolyModuleConstructor<ModuleType.CustomEnvelope>,
  ) {
    const props = { ...DEFAULT_PROPS, ...params.props };
    const monoModuleConstructor = (
      engineId: string,
      params: IModuleConstructor<ModuleType.CustomEnvelope>,
