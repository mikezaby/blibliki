...
> = {
  ...
  enterStepRecord: { gesture: "[Arm]", oled: "Arm StepRc" },
  leaveStepRecord: { gesture: "[Arm]", oled: "Arm Leave" },
  ...
  liveRecord: { gesture: "[Shift] + [Record]", oled: "S+Rec Rec" },
  stopLiveRecord: { gesture: "[Shift] + [Record]", oled: "S+Rec Stop" },
