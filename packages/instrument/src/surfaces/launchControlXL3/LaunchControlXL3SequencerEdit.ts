...
function syncSeqEditStepButtonLeds(
...
function createSeqEditPageSync(
  runtimePatch: CompiledInstrumentEnginePatch,
...
function applySeqEditEncoderEvent(
  runtimePatch: CompiledInstrumentEnginePatch,
  cc: number,
  ccValue: number,
): LaunchControlXL3SequencerEditUpdate | null {
...
export class LaunchControlXL3SequencerEdit {
  syncStepButtonLeds(
    ...
    syncSeqEditStepButtonLeds(engine, runtimePatch);
  }

  createDisplayState(
    runtimePatch: CompiledInstrumentEnginePatch,
  ): InstrumentDisplayState | null {
    return createSeqEditDisplayState(runtimePatch);
  }

  createPageSync(
    runtimePatch: CompiledInstrumentEnginePatch,
  ): LaunchControlXL3SequencerEditUpdate | null {
    return createSeqEditPageSync(runtimePatch);
  }
  ...
  applyEncoderEvent(
    ...
    return applySeqEditEncoderEvent(runtimePatch, cc, ccValue);
  }
}
